...
def clear_title_area(image: Image.Image) -> None:
    ...
    for y in range(TITLE_CLEAR_BOTTOM):
        # Preserve the original vertical gradient from the existing template.
    ...
    jobs = [
        {
            ...
            "shot": "Simulator Screenshot - iPad Pro 13-inch (M5) - 2026-02-26 at 21.36.17.png",
            "headline": "Starte sofort im Solo- oder Mehrspieler-Modus.",
            "out": "StartScreenExposed-DE.png",
        },
        {
        ...
        },
        {
            ...
            "shot": "Simulator Screenshot - iPad Pro 13-inch (M5) - 2026-02-26 at 21.37.01.png",
            "headline": "Halte die Runden mit schneller Gruppenabstimmung im Fluss.",
            "out": "IngameSafeEXPOSED-DE.png",
        },
        {
            "base": "IngameDeeperEXPOSED.png",
            "shot": "Simulator Screenshot - iPad Pro 13-inch (M5) - 2026-02-26 at 21.37.12.png",
            "headline": "Schalte tiefere Fragen frei, je höher das Level steigt.",
            "out": "IngameDeeperEXPOSED-DE.png",
        },
        {
            "base": "IngameSecretiveEXPOSED.png",
            "shot": "Simulator Screenshot - iPad Pro 13-inch (M5) - 2026-02-26 at 21.37.32.png",
            "headline": "Bring mutige Secretive-Fragen in deine nächste Runde.",
            "out": "IngameSecretiveEXPOSED-DE.png",
        },
        {
            "base": "IngameFreakyEXPOSED.png",
            "shot": "Simulator Screenshot - iPad Pro 13-inch (M5) - 2026-02-26 at 21.37.49.png",
            "headline": "Drehe die Stimmung mit dem verspielten Freaky-Modus auf.",
            "out": "IngameFreakyEXPOSED-DE.png",
        },
        {
            "base": "SettingsEXPOSED.png",
            "shot": "Simulator Screenshot - iPad Pro 13-inch (M5) - 2026-02-26 at 21.38.03.png",
            "headline": "Wechsle Sprache und rechtliche Einstellungen mit einem Tipp.",
            "out": "SettingsEXPOSED-DE.png",
        },
    ]
